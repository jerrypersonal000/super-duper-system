...
# Input fields
A = st.number_input("Enter the initial value A: ", step=1, value=st.session_state.A or 0)
B = st.number_input("Enter the lower bound B: ", step=1, value=st.session_state.B or 0)
C = st.number_input("Enter the upper bound C: ", step=1, value=st.session_state.C or 0)
